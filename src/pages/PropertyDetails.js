      ...
      <div className='flex flex-col items-start gap-8 lg:flex-row'>
        ...
        <div className='flex-1 bg-white w-full mb-8 border border-gray-300 rounded-lg px-6 py-8'>
          ...
          <form className='flex flex-col gap-y-4'>
              ...
              <textarea className='border border-gray-300 focu:border-violet-700 outline-none resize-none rounded w-full p-4 h-36 text-sm text-gray-400' placeholder='Message' defaultValue='Hello, I am interested in this property'></textarea>
